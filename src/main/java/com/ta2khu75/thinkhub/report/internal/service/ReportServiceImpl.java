package com.ta2khu75.thinkhub.report.internal.service;
...
public class ReportServiceImpl extends BaseService<Report, ReportId, ReportRepository, ReportMapper>
	...
	public ReportServiceImpl(ReportRepository repository, ReportMapper mapper, AccountApi accountService) {
