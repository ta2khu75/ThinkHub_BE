	...
	public Page<Account> search(AccountSearch search) {
		...
		List<Predicate> conditionList = Stream
				.of(applyIfNotNull(search.getRoleId(), () -> account.status.roleId.eq(search.getRoleId())),
						...
						applyIfNotNull(search.getCreatedFrom(),
								() -> account.createdAt.goe(toInstant(search.getCreatedFrom()))),
						applyIfNotNull(search.getCreatedTo(),
								() -> account.createdAt.lt(toInstant(search.getCreatedTo()))),
						applyIfNotNull(search.getUpdatedFrom(),
								() -> account.updatedAt.goe(toInstant(search.getUpdatedFrom()))),
						applyIfNotNull(search.getUpdatedTo(),
								() -> account.updatedAt.lt(toInstant(search.getUpdatedTo()))))
