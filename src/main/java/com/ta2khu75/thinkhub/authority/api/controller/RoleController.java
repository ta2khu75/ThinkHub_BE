package com.ta2khu75.thinkhub.authority.api.controller;
...
public class RoleController extends BaseController<RoleApi>
		implements CrudController<RoleRequest, RoleResponse, Long> {
	protected RoleController(RoleApi service) {
		super(service);
	}
