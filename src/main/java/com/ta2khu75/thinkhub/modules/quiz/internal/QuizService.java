package com.ta2khu75.thinkhub.modules.quiz.internal;
...
import com.ta2khu75.thinkhub.modules.quiz.internal.infra.mapper.QuizMapper;
import com.ta2khu75.thinkhub.modules.quiz.internal.infra.repository.QuizRepository;
import com.ta2khu75.thinkhub.modules.quiz.internal.validator.QuizValidator;
...
@Service
class QuizService extends BaseService<Quiz, Long, QuizRepository> implements QuizApi, IdDecodable {

	public QuizService(QuizRepository repository, QuizMapper mapper, ApplicationEventPublisher events,
	...
	public QuizResponse create(@Valid QuizRequest request) {
		...
		boolean shuffleQuestion = Boolean.TRUE.equals(request.shuffleQuestion());
//		Quiz quiz = Quiz.create(request.title(), slug, request.description(), request.duration(), ownerId,
//				request.mediaId(), request.categoryId(), shuffleQuestion, request.resultVisibility(), request.level());
