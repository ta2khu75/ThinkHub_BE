package com.ta2khu75.thinkhub.modules.quiz.draft.api.web;
...
class QuizDraftController extends BaseController<QuizDraftApi> {

	public QuizDraftController(QuizDraftApi api) {
		super(api);
	}
