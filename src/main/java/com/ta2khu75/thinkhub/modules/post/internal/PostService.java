...
@Service
class PostService extends BaseService<Post, Long, PostRepository> implements PostApi, IdDecodable {
	...
	public PostService(PostRepository repository, PostMapper mapper, ApplicationEventPublisher events,
