...
class FollowService implements FollowApi, IdDecodable {
	private final FollowRepository repository;
	private final FollowValidator validator;
	private final FollowUserPort userPort;
	...
	private PageResponse<AuthorResponse> mapToAuthorResponse(PageResponse<FollowResponse> pageResponse) {
		...
		List<AuthorResponse> authors = new ArrayList<>(userPort.readMapAuthorsByUserIds(accountIds).values());
