...
@Service
class PermissionGroupService extends BaseService<PermissionGroup, Integer, PermissionGroupRepository>
		implements PermissionGroupApi {

	public PermissionGroupService(PermissionGroupRepository repository, PermissionGroupMapper mapper) {
		super(repository);
		this.mapper = mapper;
	}
