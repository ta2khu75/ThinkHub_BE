package com.ta2khu75.thinkhub.modules.notification.internal;
...
import com.ta2khu75.thinkhub.modules.notification.internal.mapper.NotificationMapper;
import com.ta2khu75.thinkhub.modules.notification.internal.repository.NotificationRepository;
...
class NotificationService extends BaseService<Notification, Long, NotificationRepository> implements NotificationApi {
...
//	}
	...
	public PageResponse<NotificationResponse> readPage(Search search) {
		...
		Page<Notification> page = repository.findByUserId(userId, search.toPageable());
	...
	private Object resolveTarget(Notification notification) {
		String targetIdString = notification.getTargetId();
		...
		default:
			throw new IllegalArgumentException("Unexpected value: " + notification.getTarget());
		}
	}
...
//	}
	...
	public NotificationResponse read(Long id) {
		Notification notification = readEntity(id);
		NotificationResponse response = mapper.convert(notification);
		response.setTarget(this.resolveTarget(notification));
		return response;
	}
	...
	@Override
	public NotificationResponse watch(Long id) {
