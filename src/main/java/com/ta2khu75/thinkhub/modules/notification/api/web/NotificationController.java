package com.ta2khu75.thinkhub.modules.notification.api.web;
...
public class NotificationController extends BaseController<NotificationApi> {
	...
	public NotificationController(NotificationApi api) {
		super(api);
	}
	...
	public ResponseEntity<PageResponse<NotificationResponse>> readPage(@SnakeCaseModelAttribute Search search) {
		return ResponseEntity.ok(api.readPage(search));
	}
...
//		return ResponseEntity.ok(api.update(request));
//	}
