...
@ApiController("${app.api-prefix}/authorization")
public class AuthorizationController extends BaseController<AuthorizationApi> {
	protected AuthorizationController(AuthorizationApi service) {
		super(service);
	}
